...
<head>
    ...
    <link href="static/default/default.css" rel="stylesheet">
</head>
<body class="app">
<div id="loader">
        ...
        <div class="sidebar-inner">
            <div class="sidebar-logo">
                <div class="peers ai-c fxw-nw">
                    <div class="peer peer-greed"><a class="sidebar-link td-n" href="indexfeelj.html">
                        <div class="peers ai-c fxw-nw">
                            <div class="peer">
            ...
            <ul class="sidebar-menu scrollable pos-r">
                <li class="nav-item logto onclick">ENGLISH</li>
                <li class="nav-item active">
                    <a class="sidebar-link" href="/dashboard">
                    <span class="icon-holder">
                        <i class="c-blue-500 ti-home"></i> </span><span class="title">Dashboard</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="sidebar-link" href="compose.html"><span class="icon-holder"><i
                        class="c-blue-500 ti-share"></i> </span><span class="title">Compose</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="sidebar-link" href="google-maps.html">Google Map</a></li>
                        <li><a class="sidebar-link" href="vector-maps.html">Vector Map</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="dropdown-toggle" href="javascript:void(0);">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="sidebar-link" href="javascript:void(0);">Menu Item</a></li>
                                <li><a class="sidebar-link" href="javascript:void(0);">Menu Item</a></li>
                            </ul>
                        </li>
                    </ul>
        ...
        <div class="tabmain-content">
            <div id="tabmainContent">
                <div class="J_mainContent" id="content-main">
                    <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="/dashboard" data-id="/dashboard" frameborder="0"></iframe>
                </div>
            </div>
        </div>
...
<div id="rightclickmenu">
    <ul class="menu-context">
        <li class="J_refreshTab"><a>刷新</a></li>
    </ul>
</div>
